...
test('Import Wordpress XML file - File doesnt exist', async t => {
...
test('Import Wordpress XML file - Type not supported', async t => {
    const wordpressFile = path.join(process.cwd(), 'tests', 'wordpress.xml');
...
test('Import Wordpress XML file - File path not specified', async t => {
